...
export const InstagromApp = () => {
  ...
  */
  const [optimisticComments, addOptimisticComment] = useOptimistic(
    // un state como comentarios
    comments,
    (
      // similar a useReducer
      // estado actual
      currentComments,
      // nueva accion
      ...
      return [
        ...currentComments,
        // añadimos un nuevo objeto al estado
        {
          id: lastId,
          text: newCommentText,
          // simple flag
  ...
  const handleAddComment = async (formData: FormData) => {
    ...
    startTransition(async () => {
      ...
      // actualiza el componente completo para guardar los cambios en caso de no fallo
      // setComments((prev) => [
      //   ...prev,
      //   {
      //     id: new Date().getTime(),
      ...
      //! Este sería el código para revertir el proceso, porque simulamos un fallo
