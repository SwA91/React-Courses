...
export const ScrambleWords = () => {
  ...
  const handleGuessSubmit = (e: React.FormEvent) => {
    ...
    // validamos si acertamos con la palabra
    if (guess === currentWord) {
      // reduzco la palabra de mi arreglo
  ...
  const handleSkip = () => {
    // controlamos si puede o no saltar a la siguiente palabra
    if (skipCounter >= maxSkips) return;

    // eliminamos la primera palabra
  ...
  const handlePlayAgain = () => {
    // mezclamos el orden de palabras
