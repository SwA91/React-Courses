...
export const ScrambleWords = () => {
  // establecemos nuestro useReducer
  ...
  // siempre se dispara cuando el componente se des/monta
  useEffect(
    () => {
      if (points === 0) return;
    ...
    // observamos points para lanzarlos confetis
    [points]
  );
  ...
  const handlePlayAgain = () => {
    // pasamos una funcion externa como payload
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    value={guess}
                    onChange={(e) => {
                      // disparamos la accion con el nuevo valor del input
                      dispatch({
                        type: "SET_GUESS",
